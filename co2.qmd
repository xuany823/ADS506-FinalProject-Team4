...
### 5. Time Series **Visualization (**Plot)
...
#### 1.1 **Evaluate if transformation (e.g., Box–Cox) is needed**
...
#### 1.2 **Evaluate if differencing is needed**
...
#### **1.3 Evaluate if transformation (e.g., Box–Cox) is needed**
